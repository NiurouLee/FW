...
namespace NFramework.Module.UI.ScrollView
{
    public class SpecialGridViewSelectDeleteDemoScript : MonoBehaviour
    {
        ...
        ButtonPanelSpecialDelete mButtonPanel;      
        ...
        {
            mButtonPanel = new ButtonPanelSpecialDelete();
        ...
        */
        View OnGetItemByIndex(LoopList listView, int rowIndex)
        {
            ...
            BaseHorizontalToggleItemList itemScript = item.GetComponent<BaseHorizontalToggleItemList>();
