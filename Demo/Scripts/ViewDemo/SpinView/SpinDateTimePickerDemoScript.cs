...
namespace NFramework.Module.UI.ScrollView
{
    ...
    {
        public LoopList mLoopListViewMonth;
        public LoopList mLoopListViewDay;
        public LoopList mLoopListViewHour;
        public LoopList mLoopListViewMinute;
        ...
        View OnGetItemByIndexForMinute(LoopList listView, int index)
        {
        ...
        View OnGetItemByIndexForHour(LoopList listView, int index)
        {
            View item = listView.NewListViewItem("ItemPrefab");
            SpinPickerItem itemScript = item.GetComponent<SpinPickerItem>();
            if (item.IsInitHandlerCalled == false)
        ...
        View OnGetItemByIndexForMonth(LoopList listView, int index)
        {
            View item = listView.NewListViewItem("ItemPrefab");
            SpinPickerItem itemScript = item.GetComponent<SpinPickerItem>();
            if (item.IsInitHandlerCalled == false)
        ...
        View OnGetItemByIndexForDay(LoopList listView, int index)
        {
            View item = listView.NewListViewItem("ItemPrefab");
            SpinPickerItem itemScript = item.GetComponent<SpinPickerItem>();
            if (item.IsInitHandlerCalled == false)
        ...
        void OnMonthSnapTargetChanged(LoopList listView, View item)
        {
        ...
        void OnDaySnapTargetChanged(LoopList listView, View item)
        {
            int index = listView.GetIndexInShownItemList(item);
            if (index < 0)
            {
        ...
        void OnHourSnapTargetChanged(LoopList listView, View item)
        {
            int index = listView.GetIndexInShownItemList(item);
            if (index < 0)
            {
        ...
        void OnMinuteSnapTargetChanged(LoopList listView, View item)
        {
            int index = listView.GetIndexInShownItemList(item);
            if (index < 0)
            {
        ...
        void OnMonthSnapTargetFinished(LoopList listView, View item)
        {
            View item0 = mLoopListViewMonth.GetShownItemByIndex(0);
            if(item0 == null)
            {
                return;
            }
        ...
        void OnListViewSnapTargetChanged(LoopList listView, int targetIndex)
        {
            int count = listView.ShownItemCount;
            for (int i = 0; i < count; ++i)
            {
                View item2 = listView.GetShownItemByIndex(i);
