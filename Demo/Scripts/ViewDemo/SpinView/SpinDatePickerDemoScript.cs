...
namespace NFramework.Module.UI.ScrollView
{
    ...
    {
        public LoopList mLoopListViewYear;
        ...
        View OnGetItemByIndexForYear(LoopList listView, int index)
        {
        ...
        void OnYearSnapTargetChanged(LoopList listView, View item)
        {
        ...
        void OnYearSnapTargetFinished(LoopList listView, View item)
        {
            View item0 = mLoopListViewDay.GetShownItemByIndex(0);
            if(item0 == null)
            {
                return;
            }
