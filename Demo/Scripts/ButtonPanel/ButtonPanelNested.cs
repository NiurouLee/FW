...
{
    public class ButtonPanelNested
    {
        public LoopList mLoopListView;
        public DataSourceMgr<NestedItemData> mDataSourceMgr;
        ...
        {
            NestedItemData newData = mDataSourceMgr.InsertData(mDataSourceMgr.TotalItemCount);
