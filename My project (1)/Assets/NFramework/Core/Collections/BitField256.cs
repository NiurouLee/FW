...
{
    [Serializable]
    public struct BitField256 : IEquatable<BitField256>
    {
        public static int MinBitCount = 0;
        public static int MaxBitCount = 256;
        ...
        /// 获取指定位置的位状态
        /// </summary>
        /// <param name="position">位置 (0-255)</param>
        /// <returns>位状态</returns>
        public bool GetBit(int position)
        {
            if (position < MinBitCount || position >= MaxBitCount)
                throw new ArgumentOutOfRangeException(nameof(position), "Position must be between 0 and 255");
        ...
        public static bool operator ==(BitField256 left, BitField256 right)
        ...
        public override string ToString()
            => $"BitField256: 0x{_value3:X16}{_value2:X16}{_value1:X16}{_value0:X16}";

        public bool Equals(BitField256 other)
        {
        ...
        {
            return obj is BitField256 other && Equals(other);
        }
